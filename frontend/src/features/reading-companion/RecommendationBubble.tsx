    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className={cn(
            "absolute bottom-4 right-4 sm:bottom-6 sm:right-6 z-30 p-3.5 sm:p-4.5",
            READING_TOKENS.surface.recommendationBubble,
            isLaptopOrSmaller
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className={cn(READING_TOKENS.typography.subtext, "text-xs leading-relaxed mb-3 break-words")}>
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={cn(
                    READING_TOKENS.typography.action,
                    "shrink-0 whitespace-nowrap px-2.5 py-1.5 bg-slate-800/80 hover:bg-slate-800 border border-slate-700/80 rounded-lg text-slate-300 hover:text-slate-100"
                  )}
                  title="向 AI 伴读提问"
                >
