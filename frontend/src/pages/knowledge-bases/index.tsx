  ...
  return (
    <div className="h-full flex overflow-hidden bg-[#090D16] text-slate-100 font-sans select-none">
      ...
      <motion.aside
        ...
        className={`h-full bg-[#0a0e17] flex flex-col shrink-0 overflow-hidden select-none z-20 relative ${isSidebarCollapsed ? "border-r-0" : "border-r border-white/10"
          }`}
        role="region"
        aria-label="知识库目录侧边栏"
      >
                          ...
                          {group.docs.map((doc) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <div
                                  className={`w-1.5 h-1.5 rounded-full shrink-0 ml-1.5 ${isActive
                                    ? isPlanType
