...
| 领域划分 | 规范及分步 | 核心推进动作 (结合大图主线) |
| :--- | :--- | :--- |
| **业务问题域** | Step 3: 业务调研<br>Step 4: 竞品分析<br>Step 5: 业务建模 | 理解审核业务，拆解竞品并借鉴<br>提炼核心业务领域能力，完成业务与数据建模 |
| **产品交互域** | 核心交互链路设计<br>产品原型规范 | 梳理核心交互流程与完整体验<br>规划页面状态 (空态/处理/异常) 并协同 |
| **技术架构域** | System Architecture 设计<br>数据模型<br>API 规范与协议契约 | 系统架构选型评估、对齐数据模型<br>锁定各模块解耦边界、接口与协议规范 |
| **工程实现域** | 前端实现计划<br>后端实现计划<br>联调以及发布部署 | 交互表现层组件编写<br>核心服务逻辑自治编写与开发实现<br>集成联调交付、部署与发布 |
