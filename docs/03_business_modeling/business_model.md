...
| **笔记孤岛整合与极简沉淀** | 能够将阅读中的主观感悟与伴读 Agent 的辅导对话深度整合为统一的单元，并能在回顾笔记时一眼定位原文上下文细节。 | * 三栏式联动工作空间（大纲阅读 - 笔记卡片 - 伴读 Discuss）<br>* 划词记笔记与对话一键转存双通道融合<br>* Trace-to-Source 双向跳转脉冲高亮动效 |
...
| **全局图谱视角与跨项目串联** | 期望能够跳出单本书的局限，在一个全局的可交互网状视图中俯瞰所有知识，并通过节点点击快速追溯任何历史笔记。 | * 提供全局图谱视图 (Global Knowledge Graph)<br>* 可交互与点击的网状节点（原生实体与标签超节点）<br>* 跨项目沉浸式浮窗预览 (Quick Peek) |
