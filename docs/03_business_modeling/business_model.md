...
| **知行闭环与经验反哺** | 在启动新的实践项目时可一键导入 Skill 模版；在项目结束时，能将实操中总结的复盘经验沉淀为知识，实现双向闭环。 | * 普通计划项目初始化引导与 Skill 一键载入<br>* 项目归档时的经验复盘引导机制<br>* 经验笔记 (Experience Note) 同步喂入图谱 |
| **低成本且安全的个人大脑** | 能够拥有网状联想的实体关系知识图谱，但无需承担高昂 Token 账单，同时绝对确信个人数据的物理安全性。 | * 闲时后台异步增量构建图谱<br>* 限制伴读 Agent 本地/网络工具特权<br>* 纯人类审批把关的技能入库门禁 |
| **全局图谱视角与认知定位** | 期望跳出单本书的局限，在全局交互视图中俯瞰知识网络；核心目的是通过知识库的沉淀，帮助用户“看清楚自己目前所在的位置”（认知坐标），并支持快速节点追溯。 | * 提供全局图谱视图 (Global Knowledge Graph)<br>* 可交互与点击的网状节点（原生实体与标签超节点）<br>* 跨项目沉浸式浮窗预览 (Quick Peek) |
